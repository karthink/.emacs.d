 ...
 '(shackle-rules
   (quote
    ((help-mode :select nil :popup t :align t)
     ...
     (helpful-mode :select nil :popup t :align t)
     ...
     (package-menu-mode :popup t :align
                        (quote below)
                        :size 0.2)
     (TeX-output-mode :select nil :popup t :align t :size 0.2)))))
(custom-set-faces
